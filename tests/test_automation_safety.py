...
class AutomationSafetyTests(unittest.TestCase):
    ...
    def test_repository_workflow_surface_passes(self) -> None:
        result = safety.audit(ROOT / ".github" / "workflows")
        self.assertEqual("PASS", result["status"], result["findings"])

    def test_read_only_schedule_with_provider_secrets_passes(self) -> None:
        self.write(
            "observe.yml",
